...
class Player:
    ...
    def collisions_archives(self, archive):
        ...
        if archive.rect.colliderect(self.rect.x + self.dx - 1, self.rect.y + self.dy - 1, self.image.get_width() + 2, self.image.get_height() + 2):
            #s'il appuie sur E
            if pygame.key.get_pressed()[pygame.K_e]:
    ...
    def update(self, screen, room_draw, items_map, exits, signs, chests, chests_open, room_badge, room_num, room_x, room_y, electricity, props, archives):
        ...
        self.exits, self.items_map, self.chests, self.chests_open, self.archives, self.room_badge, self.room_num, self.room_x, self.room_y = exits, items_map, chests, chests_open, archives, room_badge, room_num, room_x, room_y
    ...
    def replace(self):
        ...
        return self.exits, self.items_map, self.chests, self.chests_open, self.archives, self.room_badge, self.room_x, self.room_y, self.lock, self.chest, self.archive
